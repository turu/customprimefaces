 ...
 * Author: Piotr Turek
 */
public class EnrollScheduleEntryResizeEvent extends AjaxBehaviorEvent {
    ...
    public EnrollScheduleEntryResizeEvent(UIComponent component, Behavior behavior, EnrollScheduleEvent scheduleEvent, int dayDelta, int minuteDelta) {
